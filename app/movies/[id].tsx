...
const MovieDetails = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <View className='flex flex-row justify-between w-1/2'>
            ...
            <MovieInfo label='Revenue' value={`$${(Math.round(movie?.revenue) / 1000000).toFixed(0)} million`} />
          </View>
      ...
      <TouchableOpacity
        className='absolute bottom-5 inset-x-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50'
        onPress={() => router.back()}
      >
